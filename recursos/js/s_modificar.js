(function()
{
  window.onload = function() {
    ...
    declararFormulario(formulario);
    var cedulaTitular = false;
  ...
  {
    formulario = document.getElementById("formulario");
    if (cedulaVerificar() && nombreVerificar()&& nacimientoVerificar() && sexoVerificar()
  ...
  enviandoBene = function()
  {
    ...
    if (cedulaTitVerificar() && parentescoVerificar() && cedulaBeneVerificar() && nombreVerificar() && cedulaTitular
      && nacimientoVerificar() && sexoVerificarBene() && direccionVerificar() && telefonosVerificar() && correoVerificar())
    {
      formulario.submit();
    }
    if (!cedulaTitular) {
  ...
  cedulaTitVerificar = function()
  {
    ...
    if (!expresionCedula.test(cedula))
    {
      alert("Ingrese una cedula de titular valida");
      formulario.cedulaTitular.focus();
      return false;
    }
    return true;
