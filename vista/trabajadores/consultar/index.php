        ...
        <div class="center">
          ...
          <?php
            ...
            else
            {
              ...
              {
                echo "<h3>La cedula " .$_GET['buscar'] ." no pertenece a ningún titular registrado</h3>";
    ...
    <div class="confirmar" id="confirmar">
      <div class="confirmando">
        <div class="pregunta">
          ...
          <br>
          <h4>Nota: <br> Esta persona es un titular. Si es eliminada también se elimirán
            los beneficiarios asociados a ésta</h4>
          <br>
        </div>
        <div class="si">
