<?php
  ...
  $pdf->SetFont('Times','B',12);
  $pdf->Cell(12,0.75,utf8_decode("BENEFICIARIO: "),'TLR',0,'J');//Escribimos el título de la columna sin bordes abajo
  $pdf->Cell(7,0.75,utf8_decode("CÉDULA: "),'TLR',1,'J');//Escribimos la celda sin bordes abajo para escribir el campo junto a el título
  $pdf->SetFont('Times','',12);
  ...
  $pdf->SetFont('Times','',12);
  $pdf->MultiCell(16,0.75,utf8_decode($bene->getTelefonoCelular()."   ".$bene->getTelefonoFijo()),'TBR',1,'J');

  $pdf->SetFont('Times','B',12);
  $pdf->Cell(3,0.75,utf8_decode("E-MAIL: "),'TBL',0,'J');
  $pdf->SetFont('Times','',12);
  $pdf->MultiCell(16,0.75,utf8_decode($bene->getCorreo()),'TBR',1,'J');
