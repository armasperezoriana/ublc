  ...
  public function getId()
  {
   return $this->id;
    ...
    public function registrar()
    {
      try
      {
        $sql= "INSERT INTO patologia(nombre) VALUES (:nombre)";
    ...
    public function consultar(){
      try{
        $sql="SELECT * FROM patologia WHERE nombre = :nombre";
    ...
    public function consultas($condicion = NULL){
      try{
        $sql="SELECT * FROM patologia ".$condicion;
        $consulta = $this->prepare($sql);
        $consulta->execute();
    ...
    public function modificar(){
      try{
        $sql="UPDATE patologia SET nombre=:nombre WHERE id=:id";
    ...
    public function eliminar(){
      try{
      $sql="DELETE FROM patologia WHERE id = ".$this->id;
